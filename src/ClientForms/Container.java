...
public class Container extends javax.swing.JPanel {
     ...
     private final CardInformation info;
    
    public Container(ModelContainer data) {
        this.data = data;
        initComponents();
        setOpaque(false);
        info = new CardInformation(data.getTitle(), data.getPublisher(), data.getPrice(), data.getProductid());
