 ...
 * @author Franchesca
 */
public class CardInformation extends javax.swing.JPanel {

    static int userid;
    static int productid;
    static String username;
    
    public CardInformation(String title, String publisher, String price, int prodid) {
        initComponents();
        ...
        MouseListener l = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (username == null || userid == 0){
                    PurchaseJFrame pp = new PurchaseJFrame(prodid);
                    pp.show();
                    close();
                }
                else{
                    PurchaseJFrame p = new PurchaseJFrame(userid, prodid, username);
    ...
    public void close(){
        ...
        ClientForm_JFrame frame = (ClientForm_JFrame) SwingUtilities.getWindowAncestor(this);
    ...
    public CardInformation(int id){
        userid = id;
        
    }
    
    public CardInformation(String uname){
        username = uname;
    }
